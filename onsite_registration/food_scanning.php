...
?>
			...
			<div class="appmt-form doctors-col registratio-section">
				...
				<div class="row justify-content-center">
					<div class="doctors-title text-center">
						<h2>Food Scanning (<?php echo $date;?> - Manaul)</h2>
					</div>
				</div>
					<div class="row justify-content-center">
			...
			<script>
                    ...
                    setTimeout(function () {
                        if(searchKey.length>3)
                        {
                            $.ajax({
                                type:"post",
                                url:"process.php",
                                data:"foodKey="+searchKey+"&foodM=1&foodtoken="+token,
                ...
                $.ajax({
                      type:"post",
                      url:"process.php",
                      data:{uid:uid,foodCheckin:true, foodtoken:token},
                      datatype:'json',
                      success:function(response){
                          ...
                          if(parsed)
                          {
                              $("a[data-id='"+uid+"']").removeClass("btn-success").addClass("btn-info").text("Checked In");
                          }
