...
$result=mysqli_query($conn,"update print_setup set metric='".$_POST["metric"]."',top='".$_POST["top"]."',bottom='".$_POST["bottom"]."',font='".$_POST["font"]."',paper_size='".$_POST["paper_size"]."',img_type='".$_POST["img_type"]."' where id=1");
?>
<script>
...
<body class="bg">
    <div class="container non_printable" style="width:60%">
        ...
        <?php
        $sqry_setup=mysqli_query($conn,"select * from print_setup where id=1");
...
?>
    ...
    <div class="container" id="panel">
        ...
        <div class="row" id="badge">
            <div class="col-md-6 offset-md-3" style="background: white; padding: 20px; box-shadow: 0px 1px 5px #888888;">
                <div id="top">

                </div>
                <div id="qrbox" >
                    <span class="font"><b>Title. Name</b></span>
                    <span class="font">Category</span><br>
                    <?php
