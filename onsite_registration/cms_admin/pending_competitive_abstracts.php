                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Pending Competitive Abstracts</h1>                           
							</div>
                            ...
                            <div class="pull-right hidden-xs">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <strong>Pending Competitive Abstracts</strong>
                                    </li>
                                </ol>
                            </div>
					...
					<?php } ?>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                $sqry = mysqli_query($connect, "select * from abstract_submission where status='pending' and competitive_type<>''");
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><a href="competitive_abstract_details.php?token=<?php echo $resluts['token'];?>"  id="viewDetails" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                                    </td>
                                                    ...
                                                    <td><?php echo $resluts['competitive_type'];?></td>
