                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Approved Poster (<?php echo $abs_category;?>)</h1>                           
							</div>
					...
					<?php } ?>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                $sqry = mysqli_query($connect, "select * from abstract_submission where abs_category='$abs_category' and approved_for='Poster' and status='Approve'");
                                                if (mysqli_num_rows($sqry) > 0) {
                                                    $count = 0;
