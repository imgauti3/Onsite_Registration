					...
					<?php } ?>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                $sqry = mysqli_query($connect, "select * from abstract_submission where status='Approve' and competitive_type='' and assign_status='1'");
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><a href="abstract_details.php?token=<?php echo $resluts['token'];?>"  id="viewDetails" class="btn btn-info"><i class="fa fa-eye"></i></a> <a href="javascript:void(0);" id="sendAbsMail" data-id="<?php echo $resluts['id'];?>" class="btn btn-orange"><i class="fa fa-envelope"></i></a>
                                                    </td>
