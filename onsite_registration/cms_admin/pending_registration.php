...
*$event_name*";                    		    
        ...
        echo '<script>location.href="pending_registration.php";</script>';
        exit();
}
?>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Pending Registration</h1>                           
							</div>
					...
					<?php } ?>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                $sqry = mysqli_query($connect, "select * from registration where payment_status=0");
                                                if (mysqli_num_rows($sqry) > 0) {
                                                    $count = 0;
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><a title="View Details" data-toggle="modal" id="viewDetails" href="#view_details" data-id="<?php echo $resluts['id'];?>" data-fullname="<?php echo $resluts['fullname'];?>" data-emailid="<?php echo $resluts['emailid'];?>" data-mobileno="<?php echo $resluts['mobileno'];?>" data-namecategory="<?php echo $resluts['category'];?>" data-amount="<?php echo $resluts['amount'];?>" data-payment_mode="<?php echo $resluts['payment_mode'];?>" data-transaction_id="<?php echo $resluts['transaction_id'];?>" data-transaction_date="<?php echo $resluts['transaction_date'];?>" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                                                    
                                                    <a title="Got Payment" data-toggle="modal" id="gotPayment" href="#got_payment" data-id="<?php echo $resluts['id'];?>" data-fullname="<?php echo $resluts['fullname'];?>" data-emailid="<?php echo $resluts['emailid'];?>" data-mobileno="<?php echo $resluts['mobileno'];?>" data-namecategory="<?php echo $resluts['category'];?>" data-amount="<?php echo $resluts['amount'];?>" data-payment_mode="<?php echo $resluts['payment_mode'];?>" data-transaction_id="<?php echo $resluts['transaction_id'];?>" data-transaction_date="<?php echo $resluts['transaction_date'];?>" class="btn btn-success"><i class="fa fa-credit-card"></i></a>
                                                    <a title="deleterow"  onclick="deleteregistration(<?php echo $resluts['id'];?>)" href="#" data-id="<?php echo $resluts['id'];?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
...
<!-- modal start -->
	...
	function deleteregistration(deletedId){
		if(confirm("Are you sure to delete?"))
		{
			$.ajax({
                url: "process.php",
                type: "POST",             
                data: 'pendingregdelid='+deletedId+"&pendingapproveddelete=1",
                cache: false,
                success: function(data) {
                    if(data=='DeletedSucces')
					{
						alert('Member record deleted successfully.');
						window.location.href="pending_registration.php";
					}
                }
            });
		}
