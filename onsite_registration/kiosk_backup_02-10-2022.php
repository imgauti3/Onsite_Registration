...
<style>
    ...
    @media print {
        ...
        #printSection {
			...
			<!-- -->
			<div class="appmt-form doctors-col" style="background-image: url('Banner 1200x800-01.jpg');background-repeat: no-repeat;background-size: 100% 100%;padding:100px 0px 400px;">
				<div class="container">
				<div class="row justify-content-center">
					<div class="doctors-title text-center">
					    <img src="event_logo.png" style="width:500px;">
