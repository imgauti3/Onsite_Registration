...
<style>
    ...
    @media print {
        ...
        #printSection {
			...
			<!-- -->
			<div class="appmt-form doctors-col" style="background-image: url('isg_bg.jpg');background-repeat: no-repeat;background-size: 100% 100%;padding:120px 0px 600px;">
				<div class="container">
				<div class="row justify-content-center">
					<div class="doctors-title text-center">
					    <img src="isgcon_logo.png" style="width:500px;">
